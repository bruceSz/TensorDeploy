...
def create_parser():
    ...
    parser.add_argument('--model_name',default="fcn32",help='model: faster_rcnn|centernet|fcn32')
    parser.add_argument('--backbone', default="resnet50", help='backbone to be used')
    parser.add_argument('--dataset', default="voc_seg",help='dataset to be used: voc_centernet|voc_seg')
