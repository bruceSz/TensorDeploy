...
# from vgg import VGG16_CF
# from dataset import get_loaders
# from config import Config



def train_loop(conf, model, train_loader, val_loader, model_name):
    #conf = Config()
    ...
    torch.save(model.state_dict(), os.path.join(conf.model_dir, model_name+'_epoch_' + str(conf.epoch_n + 1) + '.pth'))
